...
<div class="container center">
    ...
    <br>
    <button id="fetchDataR7" title="Tous les participants de tous les concours qui ont posté le maximum de dessins (3 dessins). Classé du plus jeune au plus vieux.">Requete 7</button>
